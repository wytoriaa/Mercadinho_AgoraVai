...
export default function Descartaveis({navigation}) {
  ...
  const querySnapshot = await prods.where('Departamento', '==', 'Descartaveis').get();
  ...
  return(
    <View style={{backgroundColor: "#FFF"}}>
      ...
      <View style={styles.bgtitulo}>
          <Text style={styles.titulo}>Descartaveis</Text>
      </View>
      <FlatList
        horizontal
        data={descartaveis}
